...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=B8AE0800-EA8D-496C-B667-7EBF4B849DCC")
        ...
        elif api[0]['Category']['Name'] == "Unhealthy_for_Sensitive_Groups": 
        ...
        elif api[0]['Category']['Name'] == "Very_Unhealthy":
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=B8AE0800-EA8D-496C-B667-7EBF4B849DCC")
